...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //URLConnection connection = new URL("https://maps.googleapis.com/maps/api/place/nearbysearch/json?" +
        //            "location=34.4140,-119.8489&radius=500&key=AIzaSyDKUzCUi5DYgGhRblNaQE1uGQQPrxrC8lA").openConnection();

        ...
        if(DatabaseFactory.is_present(String.valueOf(uri))){
            ...
            getbutton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Log.d("worile_name", String.valueOf(event_name.getText()));
                    Log.d("worile_event", String.valueOf(event_text.getText()));
                    Log.d("worile_time", String.valueOf(event_time.getText()));
